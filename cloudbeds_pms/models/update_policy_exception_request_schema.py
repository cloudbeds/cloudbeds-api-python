...
class UpdatePolicyExceptionRequestSchema(BaseModel):
    """
    UpdatePolicyExceptionRequestSchema
    """ # noqa: E501
    exception_id: StrictStr = Field(description="Policy exception ID.", alias="exceptionId")
    policy_root_id: StrictInt = Field(description="Smart policy root ID.", alias="policyRootId")
    intervals: List[PolicyExceptionIntervalSchema] = Field(description="List of date intervals for this exception.")
    rates: List[PolicyExceptionRateSchema] = Field(description="List of rates this exception applies to.")
    name: StrictStr = Field(description="Internal name for this exception.")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the exception is enabled. Omit to preserve current value.")
