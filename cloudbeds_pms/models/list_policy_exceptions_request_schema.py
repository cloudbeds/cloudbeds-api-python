...
class ListPolicyExceptionsRequestSchema(BaseModel):
    """
    ...
    policy_root_id: Optional[StrictStr] = Field(default=None, description="Filter by smart policy root ID.", alias="policyRootId")
    __properties: ClassVar[List[str]] = ["limit", "offset", "sort", "policyRootId"]
