...
class BedItemSchema(BaseModel):
    """
    BedItemSchema
    """ # noqa: E501
    type_code: StrictStr = Field(description="Bed type code (e.g., KING_SIZE_BED, SINGLE_BED)", alias="typeCode")
    capacity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Bed capacity (number of people)")
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Quantity of this bed type")
    __properties: ClassVar[List[str]] = ["typeCode", "capacity", "quantity"]
