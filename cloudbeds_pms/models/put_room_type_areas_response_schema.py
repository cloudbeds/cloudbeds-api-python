...
class PutRoomTypeAreasResponseSchema(BaseModel):
    """
    Response for PUT /rooms/v1/{roomTypeId}/areas
    """ # noqa: E501
    layout_type_code: Optional[StrictStr] = Field(description="Layout type code (null when areas are cleared)", alias="layoutTypeCode")
    areas: List[AreaItemResponseSchema] = Field(description="Areas in the room type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "areas": [AreaItemResponseSchema.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None
        })
        return _obj
