...
class GetPropertyAmenitiesResponseSchema(BaseModel):
    ...
    custom_amenities: List[StrictStr] = Field(description="List of custom property amenities", alias="customAmenities")
    __properties: ClassVar[List[str]] = ["amenities", "customAmenities"]
