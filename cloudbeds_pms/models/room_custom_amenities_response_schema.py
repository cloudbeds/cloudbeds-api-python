...
class RoomCustomAmenitiesResponseSchema(BaseModel):
    """
    RoomCustomAmenitiesResponseSchema
    """ # noqa: E501
    custom_amenities: List[StrictStr] = Field(description="List of custom room amenities", alias="customAmenities")
