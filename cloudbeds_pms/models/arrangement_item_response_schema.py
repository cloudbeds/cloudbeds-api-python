...
class ArrangementItemResponseSchema(BaseModel):
    """
    Bed arrangement in response
    """ # noqa: E501
    id: StrictInt = Field(description="Arrangement ID")
    is_default: StrictBool = Field(description="Whether this is the default arrangement", alias="isDefault")
    position: Annotated[int, Field(strict=True, ge=0)] = Field(description="Display position")
    beds: List[BedItemResponseSchema] = Field(description="Beds in this arrangement")
    __properties: ClassVar[List[str]] = ["id", "isDefault", "position", "beds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in beds (list)
        _items = []
        if self.beds:
            for _item_beds in self.beds:
                if _item_beds:
                    _items.append(_item_beds.to_dict())
            _dict['beds'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beds": [BedItemResponseSchema.from_dict(_item) for _item in obj["beds"]] if obj.get("beds") is not None else None
        })
        return _obj
