...
class EligibleRatesResponseSchema(BaseModel):
    """
    ...
    data: List[EligibleRateItemSchema] = Field(description="Eligible rates for exception creation (rate plans and base rates combined).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [EligibleRateItemSchema.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
