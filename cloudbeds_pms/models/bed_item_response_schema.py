...
class BedItemResponseSchema(BaseModel):
    """
    Bed item in response
    """ # noqa: E501
    id: StrictInt = Field(description="Bed ID")
    type_code: StrictStr = Field(description="Bed type code", alias="typeCode")
    capacity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Bed capacity")
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Quantity of this bed type")
    __properties: ClassVar[List[str]] = ["id", "typeCode", "capacity", "quantity"]
