...
class PolicyExceptionResponseSchema(BaseModel):
    """
    ...
    policy_root_id: Optional[StrictStr] = Field(default=None, alias="policyRootId")
    enabled: Optional[StrictBool] = None
    created_by: Optional[StrictStr] = Field(default=None, alias="createdBy")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    intervals: Optional[List[PolicyExceptionIntervalResponseSchema]] = None
    rates: Optional[List[PolicyExceptionRateResponseSchema]] = None
    __properties: ClassVar[List[str]] = ["id", "propertyId", "name", "policyRootId", "enabled", "createdBy", "createdAt", "updatedAt", "intervals", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intervals": [PolicyExceptionIntervalResponseSchema.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None,
            "rates": [PolicyExceptionRateResponseSchema.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
