...
class GetRoomTypeAreasResponseSchema(BaseModel):
    """
    Response for GET /rooms/v1/{roomTypeId}/areas
    """ # noqa: E501
    layout_type_code: StrictStr = Field(description="Layout type code (empty string if not set)", alias="layoutTypeCode")
    areas: List[AreaItemResponseSchema] = Field(description="Areas in the room type (ordered by position)")
