...
class DeleteRoomCustomAmenitiesRequestSchema(BaseModel):
    """
    DeleteRoomCustomAmenitiesRequestSchema
    """ # noqa: E501
    custom_amenities: Optional[List[StrictStr]] = Field(default=None, description="List of custom room amenities to remove from the room", alias="customAmenities")
    __properties: ClassVar[List[str]] = ["customAmenities"]
