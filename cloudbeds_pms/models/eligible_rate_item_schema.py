...
class EligibleRateItemSchema(BaseModel):
    """
    EligibleRateItemSchema
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the rate plan or room type.")
    type: StrictStr = Field(description="Type of rate: \"rate_plan\" or \"base_rate\".")
    package_id: Optional[StrictStr] = Field(default=None, description="Package/rate plan ID. Present only when type is \"rate_plan\".", alias="packageId")
    room_type_id: Optional[StrictStr] = Field(default=None, description="Room type ID. Present only when type is \"base_rate\".", alias="roomTypeId")
    policy_id: Optional[StrictStr] = Field(default=None, description="Smart policy ID associated with this rate plan, if any. Always null for base rates.", alias="policyId")
    __properties: ClassVar[List[str]] = ["name", "type", "packageId", "roomTypeId", "policyId"]
