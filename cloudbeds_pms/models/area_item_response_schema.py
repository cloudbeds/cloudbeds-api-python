...
class AreaItemResponseSchema(BaseModel):
    """
    Room type area in response
    """ # noqa: E501
    id: StrictInt = Field(description="Area ID")
    type_code: StrictStr = Field(description="Area type code", alias="typeCode")
    position: Annotated[int, Field(strict=True, ge=0)] = Field(description="Display position")
    arrangements: List[ArrangementItemResponseSchema] = Field(description="Bed arrangements in this area")
    __properties: ClassVar[List[str]] = ["id", "typeCode", "position", "arrangements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "arrangements": [ArrangementItemResponseSchema.from_dict(_item) for _item in obj["arrangements"]] if obj.get("arrangements") is not None else None
        })
        return _obj
