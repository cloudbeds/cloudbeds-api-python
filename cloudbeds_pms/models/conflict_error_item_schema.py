...
class ConflictErrorItemSchema(BaseModel):
    """
    ConflictErrorItemSchema
    """ # noqa: E501
    var_field: StrictStr = Field(alias="field")
    message: StrictStr
    code: Optional[StrictStr] = Field(default=None, description="Error code identifying the specific conflict")
    details: Optional[Dict[str, Any]] = Field(default=None, description="Additional details about the conflict")
    __properties: ClassVar[List[str]] = ["field", "message", "code", "details"]
