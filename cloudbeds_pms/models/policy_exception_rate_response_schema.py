...
class PolicyExceptionRateResponseSchema(BaseModel):
    """
    PolicyExceptionRateResponseSchema
    """ # noqa: E501
    package_id: Optional[StrictStr] = Field(default=None, description="Package/rate plan ID. 0 = base rate.", alias="packageId")
