...
class MyallocatorProxyResponseSchema(BaseModel):
    """
    MyallocatorProxyResponseSchema
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the MyAllocator request was successful.")
    data: Dict[str, Any] = Field(description="Response data from MyAllocator.")
    errors: List[Dict[str, Any]] = Field(description="Errors returned by MyAllocator.")
    __properties: ClassVar[List[str]] = ["success", "data", "errors"]
