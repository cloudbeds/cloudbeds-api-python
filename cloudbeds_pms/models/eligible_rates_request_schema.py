...
class EligibleRatesRequestSchema(BaseModel):
    """
    ...
    start_date: date = Field(description="Start date of the date range to filter rate plans.", alias="startDate")
    end_date: date = Field(description="End date of the date range to filter rate plans.", alias="endDate")
    __properties: ClassVar[List[str]] = ["limit", "offset", "sort", "startDate", "endDate"]
