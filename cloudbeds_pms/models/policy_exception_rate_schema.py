...
class PolicyExceptionRateSchema(BaseModel):
    """
    PolicyExceptionRateSchema
    """ # noqa: E501
    package_id: StrictInt = Field(description="Package/rate plan ID. Use 0 for base rate.", alias="packageId")
    room_type_id: Optional[StrictInt] = Field(default=None, description="Room type ID. Required when packageId is 0 (base rate).", alias="roomTypeId")
    __properties: ClassVar[List[str]] = ["packageId", "roomTypeId"]
