...
class ArrangementItemSchema(BaseModel):
    """
    ArrangementItemSchema
    """ # noqa: E501
    is_default: StrictBool = Field(description="Whether this is the default arrangement", alias="isDefault")
    position: Annotated[int, Field(strict=True, ge=0)] = Field(description="Position/order of this arrangement")
    beds: Annotated[List[BedItemSchema], Field(min_length=1)] = Field(description="List of beds in this arrangement")
    __properties: ClassVar[List[str]] = ["isDefault", "position", "beds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beds": [BedItemSchema.from_dict(_item) for _item in obj["beds"]] if obj.get("beds") is not None else None
        })
        return _obj
