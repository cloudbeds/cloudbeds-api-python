...
class PatchPolicyExceptionRequestSchema(BaseModel):
    """
    PatchPolicyExceptionRequestSchema
    """ # noqa: E501
    exception_id: StrictStr = Field(description="Policy exception ID.", alias="exceptionId")
    policy_root_id: Optional[StrictInt] = Field(default=None, description="Smart policy root ID.", alias="policyRootId")
    intervals: Optional[List[PolicyExceptionIntervalSchema]] = Field(default=None, description="List of date intervals for this exception.")
    rates: Optional[List[PolicyExceptionRateSchema]] = Field(default=None, description="List of rates this exception applies to.")
    name: Optional[StrictStr] = Field(default=None, description="Internal name for this exception.")
    enabled: Optional[StrictBool] = Field(default=None, description="Whether the exception is enabled.")
    __properties: ClassVar[List[str]] = ["exceptionId", "policyRootId", "intervals", "rates", "name", "enabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.rates:
            ...
            _dict['rates'] = _items
        # set to None if policy_root_id (nullable) is None
        # and model_fields_set contains the field
        if self.policy_root_id is None and "policy_root_id" in self.model_fields_set:
            _dict['policyRootId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyRootId": obj.get("policyRootId"),
            "intervals": [PolicyExceptionIntervalSchema.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None,
            "rates": [PolicyExceptionRateSchema.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
            "name": obj.get("name"),
