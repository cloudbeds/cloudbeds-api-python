...
class TestUpdatePolicyExceptionRequestSchema(unittest.TestCase):
    """UpdatePolicyExceptionRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePolicyExceptionRequestSchema:
        """Test UpdatePolicyExceptionRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePolicyExceptionRequestSchema`
        """
        model = UpdatePolicyExceptionRequestSchema()
        if include_optional:
            return UpdatePolicyExceptionRequestSchema(
                exception_id = '5001',
                policy_root_id = 1001,
                intervals = [
    ...
    def testUpdatePolicyExceptionRequestSchema(self):
        """Test UpdatePolicyExceptionRequestSchema"""
