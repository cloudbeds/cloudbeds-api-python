...
class TestArrangementItemResponseSchema(unittest.TestCase):
    """ArrangementItemResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrangementItemResponseSchema:
        """Test ArrangementItemResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrangementItemResponseSchema`
        """
        model = ArrangementItemResponseSchema()
        if include_optional:
            return ArrangementItemResponseSchema(
                id = 456,
                is_default = True,
                position = 0,
                beds = [
    ...
    def testArrangementItemResponseSchema(self):
        """Test ArrangementItemResponseSchema"""
