...
class TestConflictErrorItemSchema(unittest.TestCase):
    """ConflictErrorItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConflictErrorItemSchema:
        """Test ConflictErrorItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConflictErrorItemSchema`
        """
        model = ConflictErrorItemSchema()
        if include_optional:
            return ConflictErrorItemSchema(
                var_field = '',
                message = '',
    ...
    def testConflictErrorItemSchema(self):
        """Test ConflictErrorItemSchema"""
