...
class TestAgePolicySingleRequestSchema(unittest.TestCase):
    """AgePolicySingleRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgePolicySingleRequestSchema:
        """Test AgePolicySingleRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgePolicySingleRequestSchema`
        """
        model = AgePolicySingleRequestSchema()
        if include_optional:
            return AgePolicySingleRequestSchema(
                id = '1-b'
            )
        else:
            return AgePolicySingleRequestSchema(
    ...
    def testAgePolicySingleRequestSchema(self):
        """Test AgePolicySingleRequestSchema"""
