    ...
    def make_instance(self, include_optional) -> GetReservationRoomDetailsResponse:
        ...
        if include_optional:
            return GetReservationRoomDetailsResponse(
                success = True,
                message = '',
                data = cloudbeds_pms.models.get_reservation_room_details_response_data.GetReservationRoomDetailsResponse_data(
                    reservation_id = '', 
                    sub_reservation_id = '', 
                    room_id = '', 
                    room_name = '', 
                    ...
                    children = 56, 
                    guests = [
                        cloudbeds_pms.models.get_reservation_room_details_response_data_guests_inner.GetReservationRoomDetailsResponse_data_guests_inner(
                            guest_id = '', 
                            guest_first_name = '', 
                            guest_last_name = '', 
                            is_main_guest = True, )
