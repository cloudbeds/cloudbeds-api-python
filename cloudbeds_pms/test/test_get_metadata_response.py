    ...
    def make_instance(self, include_optional) -> GetMetadataResponse:
        ...
        if include_optional:
            return GetMetadataResponse(
                success = '',
                data = cloudbeds_pms.models.get_metadata_response_data.GetMetadataResponse_data(
                    api = cloudbeds_pms.models.get_metadata_response_data_api.GetMetadataResponse_data_api(
                        url = '', ), ),
                message = ''
            )
        else:
