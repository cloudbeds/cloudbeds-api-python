...
class TestGetAmenityCatalogResponseSchemaAmenitiesInner(unittest.TestCase):
    """GetAmenityCatalogResponseSchemaAmenitiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityCatalogResponseSchemaAmenitiesInner:
        """Test GetAmenityCatalogResponseSchemaAmenitiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityCatalogResponseSchemaAmenitiesInner`
        """
        model = GetAmenityCatalogResponseSchemaAmenitiesInner()
        if include_optional:
            return GetAmenityCatalogResponseSchemaAmenitiesInner(
    ...
    def testGetAmenityCatalogResponseSchemaAmenitiesInner(self):
        """Test GetAmenityCatalogResponseSchemaAmenitiesInner"""
