...
class TestPolicyExceptionRateResponseSchema(unittest.TestCase):
    """PolicyExceptionRateResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyExceptionRateResponseSchema:
        """Test PolicyExceptionRateResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyExceptionRateResponseSchema`
        """
        model = PolicyExceptionRateResponseSchema()
        if include_optional:
            return PolicyExceptionRateResponseSchema(
                package_id = '123',
                room_type_id = '456'
            )
        else:
    ...
    def testPolicyExceptionRateResponseSchema(self):
        """Test PolicyExceptionRateResponseSchema"""
