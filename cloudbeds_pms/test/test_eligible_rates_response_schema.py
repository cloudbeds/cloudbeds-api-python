...
class TestEligibleRatesResponseSchema(unittest.TestCase):
    """EligibleRatesResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EligibleRatesResponseSchema:
        """Test EligibleRatesResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EligibleRatesResponseSchema`
        """
        model = EligibleRatesResponseSchema()
        if include_optional:
            return EligibleRatesResponseSchema(
                limit = 56,
                offset = 56,
                data = [
                    cloudbeds_pms.models.eligible_rate_item_schema.EligibleRateItemSchema(
                        name = 'Standard Rate', 
                        type = 'rate_plan', 
                        package_id = '123', 
                        room_type_id = '789', 
    ...
    def testEligibleRatesResponseSchema(self):
        """Test EligibleRatesResponseSchema"""
