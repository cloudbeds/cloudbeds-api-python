...
class TestEligibleRateItemSchema(unittest.TestCase):
    """EligibleRateItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EligibleRateItemSchema:
        """Test EligibleRateItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EligibleRateItemSchema`
        """
        model = EligibleRateItemSchema()
        if include_optional:
            return EligibleRateItemSchema(
                name = 'Standard Rate',
                type = 'rate_plan',
                package_id = '123',
                room_type_id = '789',
    ...
    def testEligibleRateItemSchema(self):
        """Test EligibleRateItemSchema"""
