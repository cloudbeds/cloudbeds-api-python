...
class TestAgePolicyListResponseSchema(unittest.TestCase):
    """AgePolicyListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgePolicyListResponseSchema:
        """Test AgePolicyListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgePolicyListResponseSchema`
        """
        model = AgePolicyListResponseSchema()
        if include_optional:
            return AgePolicyListResponseSchema(
                data = [
                    cloudbeds_pms.models.age_policy_response_schema.AgePolicyResponseSchema(
                        id = '', 
                        config = '', 
                        provides_cribs = True, 
                        custom_label = '', 
    ...
    def testAgePolicyListResponseSchema(self):
        """Test AgePolicyListResponseSchema"""
