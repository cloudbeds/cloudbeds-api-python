...
class TestBedItemSchema(unittest.TestCase):
    """BedItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedItemSchema:
        """Test BedItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedItemSchema`
        """
        model = BedItemSchema()
        if include_optional:
            return BedItemSchema(
