    ...
    def make_instance(self, include_optional) -> GetRoomsResponse:
        ...
        if include_optional:
            return GetRoomsResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_rooms_response_data_inner.GetRoomsResponse_data_inner(
                        property_id = '', 
                        rooms = [
                            cloudbeds_pms.models.get_rooms_response_data_inner_rooms_inner.GetRoomsResponse_data_inner_rooms_inner(
                                room_id = '', 
                                room_name = '', 
                                dorm_room_name = '', 
                                room_description = '', 
                                ...
                                linked_room_type_qty = [
                                    cloudbeds_pms.models.get_rooms_response_data_inner_rooms_inner_linked_room_type_qty_inner.GetRoomsResponse_data_inner_rooms_inner_linkedRoomTypeQty_inner(
                                        room_type_id = '', 
                                        room_qty = 56, )
                                    ], )
                            ], )
