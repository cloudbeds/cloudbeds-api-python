    ...
    def make_instance(self, include_optional) -> GetRateJobsResponse:
        ...
        if include_optional:
            return GetRateJobsResponse(
                ...
                next_page = '',
                data = [
                    cloudbeds_pms.models.get_rate_jobs_response_data_inner.GetRateJobsResponse_data_inner(
                        job_reference_id = '', 
                        date_created = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        status = '', 
                        updates = [
                            cloudbeds_pms.models.get_rate_jobs_response_data_inner_updates_inner.GetRateJobsResponse_data_inner_updates_inner(
                                rate_id = '', 
                                action = '', 
