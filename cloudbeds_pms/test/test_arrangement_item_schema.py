...
class TestArrangementItemSchema(unittest.TestCase):
    """ArrangementItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrangementItemSchema:
        """Test ArrangementItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrangementItemSchema`
        """
        model = ArrangementItemSchema()
        if include_optional:
            return ArrangementItemSchema(
                is_default = True,
                position = 0,
                beds = [
    ...
    def testArrangementItemSchema(self):
        """Test ArrangementItemSchema"""
