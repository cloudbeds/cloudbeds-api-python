    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerLengthOfStaySettingsOneOf:
        ...
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerLengthOfStaySettingsOneOf(
                ...
                ranges = [
                    cloudbeds_pms.models.get_taxes_and_fees_response_data_inner_length_of_stay_settings_one_of_ranges_inner.GetTaxesAndFeesResponse_data_inner_lengthOfStaySettings_oneOf_ranges_inner(
                        minimum_nights = null, 
                        maximum_nights = null, 
                        amount = null, 
                        amount_adult = null, 
                        amount_child = null, 
                        amount_rate_based = [
                            cloudbeds_pms.models.get_taxes_and_fees_response_data_inner_length_of_stay_settings_one_of_ranges_inner_amount_rate_based_inner.GetTaxesAndFeesResponse_data_inner_lengthOfStaySettings_oneOf_ranges_inner_amountRateBased_inner(
                                rate = null, 
                                percentage = null, )
                            ], )
                    ]
