...
class TestPolicyExceptionListResponseSchema(unittest.TestCase):
    """PolicyExceptionListResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyExceptionListResponseSchema:
        """Test PolicyExceptionListResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyExceptionListResponseSchema`
        """
        model = PolicyExceptionListResponseSchema()
        if include_optional:
            return PolicyExceptionListResponseSchema(
                limit = 56,
                offset = 56,
                data = [
                    cloudbeds_pms.models.policy_exception_response_schema.PolicyExceptionResponseSchema(
                        id = '5001', 
                        property_id = '1234', 
    ...
    def testPolicyExceptionListResponseSchema(self):
        """Test PolicyExceptionListResponseSchema"""
