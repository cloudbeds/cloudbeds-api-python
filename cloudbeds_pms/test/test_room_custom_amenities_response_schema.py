...
class TestRoomCustomAmenitiesResponseSchema(unittest.TestCase):
    """RoomCustomAmenitiesResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomCustomAmenitiesResponseSchema:
        """Test RoomCustomAmenitiesResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomCustomAmenitiesResponseSchema`
        """
        model = RoomCustomAmenitiesResponseSchema()
        if include_optional:
            return RoomCustomAmenitiesResponseSchema(
                custom_amenities = [
                    ''
                    ]
            )
    ...
    def testRoomCustomAmenitiesResponseSchema(self):
        """Test RoomCustomAmenitiesResponseSchema"""
