    ...
    def make_instance(self, include_optional) -> GetGroupsResponse:
        ...
        if include_optional:
            return GetGroupsResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_groups_response_data_inner.GetGroupsResponse_data_inner(
                        group_code = '', 
                        name = '', 
                        type = 'group', 
                        status = 'open', 
                        ...
                        legal_name = '', 
                        contacts = [
                            cloudbeds_pms.models.get_groups_response_data_inner_contacts_inner.GetGroupsResponse_data_inner_contacts_inner(
                                id = '', 
                                group_profile_id = '', 
                                primary = True, 
                                anonymized = True, 
                                ...
                                emails = [
                                    cloudbeds_pms.models.get_groups_response_data_inner_contacts_inner_emails_inner.GetGroupsResponse_data_inner_contacts_inner_emails_inner(
                                        type = 'personal', 
                                        value = '', )
                                    ], 
                                phones = [
                                    cloudbeds_pms.models.get_groups_response_data_inner_contacts_inner_phones_inner.GetGroupsResponse_data_inner_contacts_inner_phones_inner(
                                        type = 'home', 
                                        value = '', )
                                    ], 
