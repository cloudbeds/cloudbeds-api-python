...
class TestPolicyExceptionIntervalSchema(unittest.TestCase):
    """PolicyExceptionIntervalSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyExceptionIntervalSchema:
        """Test PolicyExceptionIntervalSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyExceptionIntervalSchema`
        """
        model = PolicyExceptionIntervalSchema()
        if include_optional:
            return PolicyExceptionIntervalSchema(
    ...
    def testPolicyExceptionIntervalSchema(self):
        """Test PolicyExceptionIntervalSchema"""
