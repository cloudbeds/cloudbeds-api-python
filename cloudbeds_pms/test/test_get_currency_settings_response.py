    ...
    def make_instance(self, include_optional) -> GetCurrencySettingsResponse:
        ...
        if include_optional:
            return GetCurrencySettingsResponse(
                success = True,
                data = cloudbeds_pms.models.get_currency_settings_response_data.GetCurrencySettingsResponse_data(
                    default = '', 
                    acceptable = [
                        ''
                        ], 
                    format = cloudbeds_pms.models.get_currency_settings_response_data_format.GetCurrencySettingsResponse_data_format(
                        decimal = '', 
                        thousand = '', ), 
                    rates = cloudbeds_pms.models.get_currency_settings_response_data_rates.GetCurrencySettingsResponse_data_rates(
                        fixed = [
                            cloudbeds_pms.models.get_currency_settings_response_data_rates_fixed_inner.GetCurrencySettingsResponse_data_rates_fixed_inner(
                                currency = '', 
                                rate = 1.337, )
                            ], ), ),
                message = ''
