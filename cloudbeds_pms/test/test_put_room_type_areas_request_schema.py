...
class TestPutRoomTypeAreasRequestSchema(unittest.TestCase):
    """PutRoomTypeAreasRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRoomTypeAreasRequestSchema:
        """Test PutRoomTypeAreasRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRoomTypeAreasRequestSchema`
        """
        model = PutRoomTypeAreasRequestSchema()
        if include_optional:
            return PutRoomTypeAreasRequestSchema(
                layout_type_code = 'MULTI',
                areas = [
                    cloudbeds_pms.models.area_item_schema.AreaItemSchema(
                        type_code = 'BEDROOM', 
                        position = 0, 
                        arrangements = [
                            cloudbeds_pms.models.arrangement_item_schema.ArrangementItemSchema(
                                is_default = True, 
                                position = 0, 
                                beds = [
                                    cloudbeds_pms.models.bed_item_schema.BedItemSchema(
    ...
    def testPutRoomTypeAreasRequestSchema(self):
        """Test PutRoomTypeAreasRequestSchema"""
