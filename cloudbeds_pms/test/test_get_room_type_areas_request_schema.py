...
class TestGetRoomTypeAreasRequestSchema(unittest.TestCase):
    """GetRoomTypeAreasRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRoomTypeAreasRequestSchema:
        """Test GetRoomTypeAreasRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRoomTypeAreasRequestSchema`
        """
        model = GetRoomTypeAreasRequestSchema()
        if include_optional:
            return GetRoomTypeAreasRequestSchema(
                room_type_id = 12345
            )
        else:
            return GetRoomTypeAreasRequestSchema(
    ...
    def testGetRoomTypeAreasRequestSchema(self):
        """Test GetRoomTypeAreasRequestSchema"""
