...
class TestRoomAmenitiesUpdateSchema(unittest.TestCase):
    """RoomAmenitiesUpdateSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomAmenitiesUpdateSchema:
        """Test RoomAmenitiesUpdateSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomAmenitiesUpdateSchema`
        """
        model = RoomAmenitiesUpdateSchema()
        if include_optional:
            return RoomAmenitiesUpdateSchema(
                id = '101',
                amenities = [
    ...
    def testRoomAmenitiesUpdateSchema(self):
        """Test RoomAmenitiesUpdateSchema"""
