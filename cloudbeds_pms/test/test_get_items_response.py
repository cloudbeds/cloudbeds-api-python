    ...
    def make_instance(self, include_optional) -> GetItemsResponse:
        ...
        if include_optional:
            return GetItemsResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_items_response_data_inner.GetItemsResponse_data_inner(
                        item_id = '', 
                        item_type = 'product', 
                        sku = '', 
                        item_code = '', 
                        ...
                        stop_sell_met = True, 
                        taxes = [
                            cloudbeds_pms.models.get_item_response_data_taxes_inner.GetItemResponse_data_taxes_inner(
                                tax_name = '', 
                                tax_value = 1.337, )
                            ], 
                        total_taxes = 1.337, 
                        fees = [
                            cloudbeds_pms.models.get_item_response_data_fees_inner.GetItemResponse_data_fees_inner(
                                fee_name = '', 
                                fee_value = 1.337, )
                            ], 
                        total_fees = 1.337, 
