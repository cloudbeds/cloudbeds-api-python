...
class TestMyallocatorProxyRequestSchema(unittest.TestCase):
    """MyallocatorProxyRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyallocatorProxyRequestSchema:
        """Test MyallocatorProxyRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyallocatorProxyRequestSchema`
        """
        model = MyallocatorProxyRequestSchema()
        if include_optional:
            return MyallocatorProxyRequestSchema(
                endpoint = 'RoomUpdate',
                payload = None
            )
        else:
    ...
    def testMyallocatorProxyRequestSchema(self):
        """Test MyallocatorProxyRequestSchema"""
