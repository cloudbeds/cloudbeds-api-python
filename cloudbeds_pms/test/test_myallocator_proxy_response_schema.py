...
class TestMyallocatorProxyResponseSchema(unittest.TestCase):
    """MyallocatorProxyResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyallocatorProxyResponseSchema:
        """Test MyallocatorProxyResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyallocatorProxyResponseSchema`
        """
        model = MyallocatorProxyResponseSchema()
        if include_optional:
            return MyallocatorProxyResponseSchema(
                success = True,
                data = None,
                errors = [
                    None
    ...
    def testMyallocatorProxyResponseSchema(self):
        """Test MyallocatorProxyResponseSchema"""
