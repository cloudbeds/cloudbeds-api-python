...
class TestGetRoomTypeAreasResponseSchema(unittest.TestCase):
    """GetRoomTypeAreasResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRoomTypeAreasResponseSchema:
        """Test GetRoomTypeAreasResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRoomTypeAreasResponseSchema`
        """
        model = GetRoomTypeAreasResponseSchema()
        if include_optional:
            return GetRoomTypeAreasResponseSchema(
    ...
    def testGetRoomTypeAreasResponseSchema(self):
        """Test GetRoomTypeAreasResponseSchema"""
