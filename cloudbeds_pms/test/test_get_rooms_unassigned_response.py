    ...
    def make_instance(self, include_optional) -> GetRoomsUnassignedResponse:
        ...
        if include_optional:
            return GetRoomsUnassignedResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_rooms_unassigned_response_data_inner.GetRoomsUnassignedResponse_data_inner(
                        property_id = '', 
                        rooms = [
                            cloudbeds_pms.models.get_rooms_unassigned_response_data_inner_rooms_inner.GetRoomsUnassignedResponse_data_inner_rooms_inner(
                                room_id = '', 
                                room_name = '', 
                                dorm_room_name = '', 
                                room_description = '', 
