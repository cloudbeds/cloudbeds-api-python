    ...
    def make_instance(self, include_optional) -> GetRoomBlocksResponse:
        ...
        if include_optional:
            return GetRoomBlocksResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_room_blocks_response_data_inner.GetRoomBlocksResponse_data_inner(
                        room_block_id = '', 
                        room_block_reason = '', 
                        start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        rooms = [
                            cloudbeds_pms.models.get_room_blocks_response_data_inner_rooms_inner.GetRoomBlocksResponse_data_inner_rooms_inner(
                                event_id = '', 
                                room_id = '', 
                                room_type_id = '', 
                                is_source = True, )
