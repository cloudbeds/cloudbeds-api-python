    ...
    def make_instance(self, include_optional) -> ReservationCommissionResponseSchema:
        ...
        if include_optional:
            return ReservationCommissionResponseSchema(
                ...
                estimated_commission_from_source = cloudbeds_pms.models.money_schema.MoneySchema(
                    amount = '12439', 
                    currency_code = 'USD', ),
                estimated_commissionable_revenue = cloudbeds_pms.models.money_schema.MoneySchema(
                    amount = '12439', 
                    currency_code = 'USD', ),
                channel_commission = cloudbeds_pms.models.money_schema.MoneySchema(
                    amount = '12439', 
                    currency_code = 'USD', ),
