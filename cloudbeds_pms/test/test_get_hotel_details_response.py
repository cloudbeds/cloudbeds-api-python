    ...
    def make_instance(self, include_optional) -> GetHotelDetailsResponse:
        ...
        if include_optional:
            return GetHotelDetailsResponse(
                success = True,
                data = cloudbeds_pms.models.get_hotel_details_response_data.GetHotelDetailsResponse_data(
                    property_id = '', 
                    organization_id = '', 
                    property_name = '', 
                    property_type = '', 
                    ...
                    property_currency = cloudbeds_pms.models.get_hotel_details_response_data_property_currency.GetHotelDetailsResponse_data_propertyCurrency(
                        currency_code = '', 
                        currency_symbol = '', 
                    ...
                    property_phone = '', 
                    property_email = '', 
                    property_address = cloudbeds_pms.models.get_hotel_details_response_data_property_address.GetHotelDetailsResponse_data_propertyAddress(
                        property_address1 = '', 
                        property_address2 = '', 
                        property_city = '', 
                        property_state = '', 
                        ...
                        property_latitude = '', 
                        property_longitude = '', ), 
                    property_policy = cloudbeds_pms.models.get_hotel_details_response_data_property_policy.GetHotelDetailsResponse_data_propertyPolicy(
