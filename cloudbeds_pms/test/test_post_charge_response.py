    ...
    def make_instance(self, include_optional) -> PostChargeResponse:
        ...
        if include_optional:
            return PostChargeResponse(
                success = True,
                data = cloudbeds_pms.models.post_charge_response_data.PostChargeResponse_data(
                    payment_id = '', 
                    transaction_id = '', 
                    payment_status = '', 
                    payment_type = '', 
                    next_action = cloudbeds_pms.models.post_charge_response_data_next_action.PostChargeResponse_data_nextAction(
                        type = '', 
                        details = cloudbeds_pms.models.post_charge_response_data_next_action_details.PostChargeResponse_data_nextAction_details(
                            url = '', 
                            method = '', ), ), )
            )
        else:
