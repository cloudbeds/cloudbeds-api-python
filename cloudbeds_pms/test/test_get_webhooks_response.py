    ...
    def make_instance(self, include_optional) -> GetWebhooksResponse:
        ...
        if include_optional:
            return GetWebhooksResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_webhooks_response_data_inner.GetWebhooksResponse_data_inner(
                        id = '', 
                        key = cloudbeds_pms.models.get_webhooks_response_data_inner_key.GetWebhooksResponse_data_inner_key(
                            type = 'user', 
                            id = '', ), 
                        event = cloudbeds_pms.models.get_webhooks_response_data_inner_event.GetWebhooksResponse_data_inner_event(
                            entity = '', 
                            action = '', ), 
                        owner = cloudbeds_pms.models.get_webhooks_response_data_inner_owner.GetWebhooksResponse_data_inner_owner(
                            type = '', 
                            id = '', ), 
                        subscription_type = '', 
                        subscription_data = cloudbeds_pms.models.get_webhooks_response_data_inner_subscription_data.GetWebhooksResponse_data_inner_subscriptionData(
                            endpoint = '', ), )
                    ]
            )
        else:
