    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettingsOneOf:
        ...
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettingsOneOf(
                ...
                ranges = [
                    cloudbeds_pms.models.get_taxes_and_fees_response_data_inner_date_ranges_inner_length_of_stay_settings_one_of_ranges_inner.GetTaxesAndFeesResponse_data_inner_dateRanges_inner_lengthOfStaySettings_oneOf_ranges_inner(
                        minimum_nights = 56, 
                        maximum_nights = 56, 
                        amount = null, 
                        amount_adult = null, 
