...
class TestCreatePolicyExceptionRequestSchema(unittest.TestCase):
    """CreatePolicyExceptionRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePolicyExceptionRequestSchema:
        """Test CreatePolicyExceptionRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePolicyExceptionRequestSchema`
        """
        model = CreatePolicyExceptionRequestSchema()
        if include_optional:
            return CreatePolicyExceptionRequestSchema(
                policy_root_id = 1001,
                intervals = [
                    cloudbeds_pms.models.policy_exception_interval_schema.PolicyExceptionIntervalSchema(
                ...
                rates = [
                    cloudbeds_pms.models.policy_exception_rate_schema.PolicyExceptionRateSchema(
                        package_id = 123, 
                        room_type_id = 456, )
                    ],
    ...
    def testCreatePolicyExceptionRequestSchema(self):
        """Test CreatePolicyExceptionRequestSchema"""
