    ...
    def make_instance(self, include_optional) -> GetHotelsResponse:
        ...
        if include_optional:
            return GetHotelsResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_hotels_response_data_inner.GetHotelsResponse_data_inner(
                        property_id = '', 
                        organization_id = '', 
                        property_name = '', 
                        property_image = '', 
                        ...
                        property_timezone = '', 
                        property_currency = [
                            cloudbeds_pms.models.get_hotels_response_data_inner_property_currency_inner.GetHotelsResponse_data_inner_propertyCurrency_inner(
                                currency_code = '', 
                                currency_symbol = '', 
                                currency_position = '', )
                            ], )
