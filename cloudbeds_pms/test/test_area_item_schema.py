...
class TestAreaItemSchema(unittest.TestCase):
    """AreaItemSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaItemSchema:
        """Test AreaItemSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaItemSchema`
        """
        model = AreaItemSchema()
        if include_optional:
            return AreaItemSchema(
                type_code = 'BEDROOM',
                position = 0,
                arrangements = [
