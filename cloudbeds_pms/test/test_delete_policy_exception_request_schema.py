...
class TestDeletePolicyExceptionRequestSchema(unittest.TestCase):
    """DeletePolicyExceptionRequestSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletePolicyExceptionRequestSchema:
        """Test DeletePolicyExceptionRequestSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePolicyExceptionRequestSchema`
        """
        model = DeletePolicyExceptionRequestSchema()
        if include_optional:
            return DeletePolicyExceptionRequestSchema(
                exception_id = '5001'
            )
        else:
            return DeletePolicyExceptionRequestSchema(
    ...
    def testDeletePolicyExceptionRequestSchema(self):
        """Test DeletePolicyExceptionRequestSchema"""
