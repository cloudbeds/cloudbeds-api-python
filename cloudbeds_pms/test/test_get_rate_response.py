    ...
    def make_instance(self, include_optional) -> GetRateResponse:
        ...
        if include_optional:
            return GetRateResponse(
                success = True,
                data = cloudbeds_pms.models.get_rate_response_data.GetRateResponse_data(
                    rate_id = '', 
                    is_derived = True, 
                    room_rate = 1.337, 
                    total_rate = 1.337, 
                    ...
                    room_rate_detailed = [
                        cloudbeds_pms.models.get_rate_response_data_room_rate_detailed_inner.GetRateResponse_data_roomRateDetailed_inner(
