    ...
    def make_instance(self, include_optional) -> GetSourcesResponse:
        ...
        if include_optional:
            return GetSourcesResponse(
                success = True,
                data = [
                    cloudbeds_pms.models.get_sources_response_data_inner.GetSourcesResponse_data_inner(
                        property_id = '', 
                        source_id = '', 
                        source_name = '', 
                        is_third_party = True, 
                        ...
                        taxes = [
                            cloudbeds_pms.models.get_sources_response_data_inner_taxes_inner.GetSourcesResponse_data_inner_taxes_inner(
                                tax_id = '', 
                                name = '', 
                                amount = 1.337, 
                        ...
                        fees = [
                            cloudbeds_pms.models.get_sources_response_data_inner_fees_inner.GetSourcesResponse_data_inner_fees_inner(
                                fee_id = 56, 
                                name = '', 
                                amount = 1.337, 
                                amount_type = 'percentage', 
