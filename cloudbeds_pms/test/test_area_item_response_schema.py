...
class TestAreaItemResponseSchema(unittest.TestCase):
    """AreaItemResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaItemResponseSchema:
        """Test AreaItemResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaItemResponseSchema`
        """
        model = AreaItemResponseSchema()
        if include_optional:
            return AreaItemResponseSchema(
                id = 789,
                type_code = 'BEDROOM',
                position = 0,
                arrangements = [
    ...
    def testAreaItemResponseSchema(self):
        """Test AreaItemResponseSchema"""
