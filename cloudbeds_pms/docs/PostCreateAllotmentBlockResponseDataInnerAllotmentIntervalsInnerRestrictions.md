...
```python
from cloudbeds_pms.models.post_create_allotment_block_response_data_inner_allotment_intervals_inner_restrictions import PostCreateAllotmentBlockResponseDataInnerAllotmentIntervalsInnerRestrictions
