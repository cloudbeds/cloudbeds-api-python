...
**guest_document_expiration_date** | **str** |  | [optional] 
...
```python
from cloudbeds_pms.models.get_reservations_with_rate_details_response_data_inner_guest_list_value import GetReservationsWithRateDetailsResponseDataInnerGuestListValue
