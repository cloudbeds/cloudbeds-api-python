...
from cloudbeds_pms.models.get_currency_settings_response import GetCurrencySettingsResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.CurrencyApi(api_client)
