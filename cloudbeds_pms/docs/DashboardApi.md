...
from cloudbeds_pms.models.get_dashboard_response import GetDashboardResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.DashboardApi(api_client)
