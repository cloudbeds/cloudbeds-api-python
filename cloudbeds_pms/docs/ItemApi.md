...
from cloudbeds_pms.models.post_append_custom_item_response import PostAppendCustomItemResponse
from cloudbeds_pms.models.post_custom_item_request_items_inner import PostCustomItemRequestItemsInner
from cloudbeds_pms.models.post_custom_item_request_payments_inner import PostCustomItemRequestPaymentsInner
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.ItemApi(api_client)
    ...
    items = [cloudbeds_pms.PostCustomItemRequestItemsInner()] # List[PostCustomItemRequestItemsInner] | list of items will be posted (optional)
    ...
    payments = [cloudbeds_pms.PostCustomItemRequestPaymentsInner()] # List[PostCustomItemRequestPaymentsInner] | list of payments If the item is already paid (optional)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_item_categories_response import GetItemCategoriesResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_item_response import GetItemResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_items_response import GetItemsResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
from cloudbeds_pms.models.post_custom_item_request_items_inner import PostCustomItemRequestItemsInner
from cloudbeds_pms.models.post_custom_item_request_payments_inner import PostCustomItemRequestPaymentsInner
from cloudbeds_pms.models.post_custom_item_response import PostCustomItemResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_item_category_response import PostItemCategoryResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_item_request_payments_inner import PostItemRequestPaymentsInner
from cloudbeds_pms.models.post_item_response import PostItemResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    sale_date = '2013-10-20T19:20:30+01:00' # datetime | Posting date. Defaults to current date. (optional)
    payments = [cloudbeds_pms.PostItemRequestPaymentsInner()] # List[PostItemRequestPaymentsInner] | list of payments If the item is already paid (optional)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_items_to_inventory_request_item import PostItemsToInventoryRequestItem
from cloudbeds_pms.models.post_items_to_inventory_response import PostItemsToInventoryResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cloudbeds_pms.ItemApi(api_client)
    item = cloudbeds_pms.PostItemsToInventoryRequestItem() # PostItemsToInventoryRequestItem |  (optional)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_void_item_response import PostVoidItemResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.put_item_to_inventory_response import PutItemToInventoryResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
