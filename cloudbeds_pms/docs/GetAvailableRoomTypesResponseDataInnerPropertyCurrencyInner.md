...
```python
from cloudbeds_pms.models.get_available_room_types_response_data_inner_property_currency_inner import GetAvailableRoomTypesResponseDataInnerPropertyCurrencyInner
