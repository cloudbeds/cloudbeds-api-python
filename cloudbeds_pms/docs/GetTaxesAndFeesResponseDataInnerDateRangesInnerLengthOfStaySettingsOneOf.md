...
```python
from cloudbeds_pms.models.get_taxes_and_fees_response_data_inner_date_ranges_inner_length_of_stay_settings_one_of import GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettingsOneOf
