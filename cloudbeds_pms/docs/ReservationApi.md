...
from cloudbeds_pms.models.delete_reservation_note_response import DeleteReservationNoteResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.ReservationApi(api_client)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_reservation_assignments_response import GetReservationAssignmentsResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_reservation_response import GetReservationResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_reservation_notes_response import GetReservationNotesResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_reservations_response import GetReservationsResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_reservations_with_rate_details_response import GetReservationsWithRateDetailsResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_sources_response import GetSourcesResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_reservation_document_response import PostReservationDocumentResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_reservation_note_response import PostReservationNoteResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_reservation_request_adults_inner import PostReservationRequestAdultsInner
from cloudbeds_pms.models.post_reservation_request_children_inner import PostReservationRequestChildrenInner
from cloudbeds_pms.models.post_reservation_request_custom_fields_inner import PostReservationRequestCustomFieldsInner
from cloudbeds_pms.models.post_reservation_request_rooms_inner import PostReservationRequestRoomsInner
from cloudbeds_pms.models.post_reservation_response import PostReservationResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    rooms = [cloudbeds_pms.PostReservationRequestRoomsInner()] # List[PostReservationRequestRoomsInner] | Array with quantity of rooms (optional)
    adults = [cloudbeds_pms.PostReservationRequestAdultsInner()] # List[PostReservationRequestAdultsInner] | Array with number of adults (optional)
    children = [cloudbeds_pms.PostReservationRequestChildrenInner()] # List[PostReservationRequestChildrenInner] | Array with number of children (optional)
    ...
    custom_fields = [cloudbeds_pms.PostReservationRequestCustomFieldsInner()] # List[PostReservationRequestCustomFieldsInner] | Array with custom fields information (optional)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.put_reservation_note_response import PutReservationNoteResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.put_reservation_request_custom_fields_inner import PutReservationRequestCustomFieldsInner
from cloudbeds_pms.models.put_reservation_request_rooms_inner import PutReservationRequestRoomsInner
from cloudbeds_pms.models.put_reservation_response import PutReservationResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    custom_fields = [cloudbeds_pms.PutReservationRequestCustomFieldsInner()] # List[PutReservationRequestCustomFieldsInner] | Array with custom fields information (optional)
    rooms = [cloudbeds_pms.PutReservationRequestRoomsInner()] # List[PutReservationRequestRoomsInner] | Array with rooms information to change accommodations assigned to the reservation (optional)
