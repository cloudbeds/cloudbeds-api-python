# cloudbeds_pms.AllotmentBlocksApi
...
from cloudbeds_pms.models.post_create_allotment_block_notes_response import PostCreateAllotmentBlockNotesResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.AllotmentBlocksApi(api_client)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_create_allotment_block_request_allotment_intervals_inner import PostCreateAllotmentBlockRequestAllotmentIntervalsInner
from cloudbeds_pms.models.post_create_allotment_block_request_auto_release import PostCreateAllotmentBlockRequestAutoRelease
from cloudbeds_pms.models.post_create_allotment_block_response import PostCreateAllotmentBlockResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    auto_release = cloudbeds_pms.PostCreateAllotmentBlockRequestAutoRelease() # PostCreateAllotmentBlockRequestAutoRelease |  (optional)
    allotment_intervals = [cloudbeds_pms.PostCreateAllotmentBlockRequestAllotmentIntervalsInner()] # List[PostCreateAllotmentBlockRequestAllotmentIntervalsInner] | The day-based data for the allotment block. (optional)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_delete_allotment_block_response import PostDeleteAllotmentBlockResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_allotment_blocks_response import GetAllotmentBlocksResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.get_list_allotment_block_notes_response import GetListAllotmentBlockNotesResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_update_allotment_block_notes_response import PostUpdateAllotmentBlockNotesResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_update_allotment_block_request_allotment_intervals_inner import PostUpdateAllotmentBlockRequestAllotmentIntervalsInner
from cloudbeds_pms.models.post_update_allotment_block_request_auto_release import PostUpdateAllotmentBlockRequestAutoRelease
from cloudbeds_pms.models.post_update_allotment_block_response import PostUpdateAllotmentBlockResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    allotment_type = 'allotment_type_example' # str | The allotment type (optional)
    allotment_block_status = 'allotment_block_status_example' # str | The status for the allotment block under (optional)
    auto_release = cloudbeds_pms.PostUpdateAllotmentBlockRequestAutoRelease() # PostUpdateAllotmentBlockRequestAutoRelease |  (optional)
    allotment_intervals = [cloudbeds_pms.PostUpdateAllotmentBlockRequestAllotmentIntervalsInner()] # List[PostUpdateAllotmentBlockRequestAllotmentIntervalsInner] | The day-based data for the allotment block. (optional)
