...
from cloudbeds_pms.models.get_custom_fields_response import GetCustomFieldsResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.CustomFieldsApi(api_client)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_custom_field_response import PostCustomFieldResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
