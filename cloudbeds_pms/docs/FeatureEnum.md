...
* `FEATURE_DOT_INVENTORY_DOT_DERIVED_MINUS_RATE_MINUS_PLANS_MINUS_FROM_MINUS_ANOTHER_MINUS_DERIVED_MINUS_RATE_MINUS_PLANS` (value: `'feature.inventory.derived-rate-plans-from-another-derived-rate-plans'`)
