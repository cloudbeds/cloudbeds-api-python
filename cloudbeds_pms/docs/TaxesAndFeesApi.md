...
from cloudbeds_pms.models.get_taxes_and_fees_response import GetTaxesAndFeesResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.TaxesAndFeesApi(api_client)
