...
[**import_task_controller_reimport**](ImportTasksApi.md#import_task_controller_reimport) | **POST** /import/v1/tasks/{taskId} | ReImport an import task and generate a temporary upload URL.
...
> ImportTaskResponseSchema import_task_controller_get_all(x_property_id, limit=limit, offset=offset, filters=filters)
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetch a list of previously uploaded imports.
        api_response = api_instance.import_task_controller_get_all(x_property_id, limit=limit, offset=offset, filters=filters)
...
# **import_task_controller_reimport**
> ImportTaskResponseSchema import_task_controller_reimport(x_property_id, task_id)
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    try:
        # ReImport an import task and generate a temporary upload URL.
        api_response = api_instance.import_task_controller_reimport(x_property_id, task_id)
        print("The response of ImportTasksApi->import_task_controller_reimport:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImportTasksApi->import_task_controller_reimport: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**201** | A reimport task was created. |  -  |
**404** | Parent import task not found. |  -  |
**400** | Bad Request response |  -  |
**500** | Internal Server Error |  -  |
