...
from cloudbeds_pms.models.delete_adjustment_response import DeleteAdjustmentResponse
...
with cloudbeds_pms.ApiClient(configuration) as api_client:
    ...
    api_instance = cloudbeds_pms.AdjustmentApi(api_client)
...
```python
import cloudbeds_pms
from cloudbeds_pms.models.post_adjustment_response import PostAdjustmentResponse
from cloudbeds_pms.rest import ApiException
from pprint import pprint
