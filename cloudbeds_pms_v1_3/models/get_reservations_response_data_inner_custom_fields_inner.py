...
class GetReservationsResponseDataInnerCustomFieldsInner(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.custom_field_id is None and "custom_field_id" in self.model_fields_set:
            _dict['customFieldID'] = None

        # set to None if shortcode (nullable) is None
        # and model_fields_set contains the field
        if self.shortcode is None and "shortcode" in self.model_fields_set:
