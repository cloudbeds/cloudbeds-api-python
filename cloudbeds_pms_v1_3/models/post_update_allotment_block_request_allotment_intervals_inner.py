...
class PostUpdateAllotmentBlockRequestAllotmentIntervalsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policyId", "splitInventory", "roomTypeId", "availability"]
