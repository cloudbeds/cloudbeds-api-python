...
class PostRoomBlockResponse(BaseModel):
    ...
    room_block_type: Optional[StrictStr] = Field(default=None, description="Room block type. ‘blocked_dates’ - Room block. ‘out_of_service’ - Out of service block. ‘courtesy_hold’ - Courtesy hold block.", alias="roomBlockType")
