...
**custom_fields** | [**List[GetReservationsResponseDataInnerCustomFieldsInner]**](GetReservationsResponseDataInnerCustomFieldsInner.md) | List of guest custom fields | [optional] 
