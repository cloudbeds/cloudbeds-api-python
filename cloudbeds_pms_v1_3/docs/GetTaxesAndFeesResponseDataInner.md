...
**fees_charged** | **List[str]** | List of Fee IDs charged by the current tax (tax-on-fee). Only exists if type &#x3D; tax. | [optional] 
**taxes_charged** | **List[str]** | List of Tax IDs charged by the current tax (tax-on-tax). Only exists if type &#x3D; tax. | [optional] 
