...
class PaymentApi:
    ...
    def post_payment_post(
        ...
        group_id: Annotated[Optional[StrictStr], Field(description="Group ID. Required if neither reservationID nor houseAccountID is sent")] = None,
        ...
        :type house_account_id: str
        :param group_id: Group ID. Required if neither reservationID nor houseAccountID is sent
        :type group_id: str
