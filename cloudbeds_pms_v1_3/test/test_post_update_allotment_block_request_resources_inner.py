...
class TestPostUpdateAllotmentBlockRequestResourcesInner(unittest.TestCase):
    """PostUpdateAllotmentBlockRequestResourcesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostUpdateAllotmentBlockRequestResourcesInner:
        """Test PostUpdateAllotmentBlockRequestResourcesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostUpdateAllotmentBlockRequestResourcesInner`
        """
        model = PostUpdateAllotmentBlockRequestResourcesInner()
        if include_optional:
            return PostUpdateAllotmentBlockRequestResourcesInner(
                id = '',
                resource_type_id = '',
                resource_id = '',
    ...
    def testPostUpdateAllotmentBlockRequestResourcesInner(self):
        """Test PostUpdateAllotmentBlockRequestResourcesInner"""
