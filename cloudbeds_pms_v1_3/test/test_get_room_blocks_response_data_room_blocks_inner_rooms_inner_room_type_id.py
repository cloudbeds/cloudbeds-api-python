...
class TestGetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID(unittest.TestCase):
    """GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID:
        """Test GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID`
        """
        model = GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID()
        if include_optional:
            return GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID(
            )
        else:
            return GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID(
        )
    ...
    def testGetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID(self):
        """Test GetRoomBlocksResponseDataRoomBlocksInnerRoomsInnerRoomTypeID"""
