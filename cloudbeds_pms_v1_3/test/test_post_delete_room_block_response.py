...
class TestPostDeleteRoomBlockResponse(unittest.TestCase):
    """PostDeleteRoomBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostDeleteRoomBlockResponse:
        """Test PostDeleteRoomBlockResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostDeleteRoomBlockResponse`
        """
        model = PostDeleteRoomBlockResponse()
        if include_optional:
            return PostDeleteRoomBlockResponse(
                success = True,
                message = ''
            )
        else:
    ...
    def testPostDeleteRoomBlockResponse(self):
        """Test PostDeleteRoomBlockResponse"""
