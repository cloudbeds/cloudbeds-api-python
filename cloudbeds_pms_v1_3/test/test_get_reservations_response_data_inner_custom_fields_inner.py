...
class TestGetReservationsResponseDataInnerCustomFieldsInner(unittest.TestCase):
    """GetReservationsResponseDataInnerCustomFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationsResponseDataInnerCustomFieldsInner:
        """Test GetReservationsResponseDataInnerCustomFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationsResponseDataInnerCustomFieldsInner`
        """
        model = GetReservationsResponseDataInnerCustomFieldsInner()
        if include_optional:
            return GetReservationsResponseDataInnerCustomFieldsInner(
                custom_field_id = '',
                shortcode = '',
                is_active = True,
                custom_field_name = '',
    ...
    def testGetReservationsResponseDataInnerCustomFieldsInner(self):
        """Test GetReservationsResponseDataInnerCustomFieldsInner"""
