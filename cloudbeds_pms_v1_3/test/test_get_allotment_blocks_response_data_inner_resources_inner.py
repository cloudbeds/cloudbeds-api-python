...
class TestGetAllotmentBlocksResponseDataInnerResourcesInner(unittest.TestCase):
    """GetAllotmentBlocksResponseDataInnerResourcesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllotmentBlocksResponseDataInnerResourcesInner:
        """Test GetAllotmentBlocksResponseDataInnerResourcesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllotmentBlocksResponseDataInnerResourcesInner`
        """
        model = GetAllotmentBlocksResponseDataInnerResourcesInner()
        if include_optional:
            return GetAllotmentBlocksResponseDataInnerResourcesInner(
                id = '',
                resource_type_id = '',
                resource_id = '',
    ...
    def testGetAllotmentBlocksResponseDataInnerResourcesInner(self):
        """Test GetAllotmentBlocksResponseDataInnerResourcesInner"""
